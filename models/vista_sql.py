...
class VistaSQL(models.Model):
    ...
    STRING_AGG(ap.name, ', ') AS pagos_asociados  -- Muestra los pagos como PBNK1/Factura
...
LEFT JOIN account_payment ap ON ap.id = aml_pago.payment_id  -- Aquí obtenemos `ap.name`
